...
const resetModalData = () => {
	modalReport.value.open = false;
	modalReportType.value = null;
};
...
const handleModalReportAccept = () => {
	resetModalData();
};

const handleModalReportCancel = () => {
	resetModalData();
};
...
<template>
	...
	<Modal
		ref="modalReport"
		@accept="handleModalReportAccept"
		@cancel="handleModalReportCancel"
	>
		<template #title>
			<template v-if="modalReportType === 'view'">View report</template>
		</template>
